...
public class ValidatorAllowDelegation extends DataObject {

  @JsonProperty("allow_delegation")
  private Boolean allowDelegation;

  public ValidatorAllowDelegation allowDelegation(Boolean allowDelegation) {
  ...
  */
  ...
  public ValidatorAllowDelegation type(String type) {
    super.setType(type);
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValidatorAllowDelegation validatorAllowDelegation = (ValidatorAllowDelegation) o;
    return Objects.equals(this.allowDelegation, validatorAllowDelegation.allowDelegation) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowDelegation, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValidatorAllowDelegation {\n");
